...
export const RoundedUserDiv = styled.div<{ active?: boolean }>`
...
export const NewNotifications = styled.div<{ count?: string }>`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 16px;
...
export const Menu = styled.div`
  ...
  border-radius: 5px;
`;
export const NewFriendsNotifications = styled.div<{ count?: number }>`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 20px;
